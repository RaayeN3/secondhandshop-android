...
public class AdvertCarTest {
    ...
    private AdvertCar toyota = new AdvertCar("content://media/external/images/media/99", "Toyota", "Prius", 2012, 5000.0, "Waterford", "Car is well-kept. Mileage is only 50,000!");
    private AdvertCar honda = new AdvertCar("content://media/external/images/media/150", "Honda", "Fit", 2014, 3500.0, "Dunmore East", "What a garbage. Trying to get rid of it...");
    ...
    public void testToString() {
        assertEquals("AdvertCar{carID=1, imageUri='content://media/external/images/media/99', carMake='Toyota', carModel='Prius', carYear=2012, carPrice=5000.0, carLocation='Waterford', carDescription='Car is well-kept. Mileage is only 50,000!'}",
                toyota.toString());

        assertEquals("AdvertCar{carID=2, imageUri='content://media/external/images/media/150', carMake='Honda', carModel='Fit', carYear=2014, carPrice=3500.0, carLocation='Dunmore East', carDescription='What a garbage. Trying to get rid of it...'}",
                honda.toString());
    }
